...
<div class="Slide">
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div onClick="location.href='Poori.html'" class="carousel-item active">
            <img src="poori1.jpg" class="d-block w-100" alt="Idli">
            <div class="carousel-caption d-none d-md-block">
              <h5>Poori</h5>
              
            </div>
          </div>
          <div onClick="location.href='BreadOmlet.html'" class="carousel-item">
            <img src="BreadOmlet.jpg" class="d-block w-100" alt="Chicken">
            <div class="carousel-caption d-none d-md-block">
              <h5>Bread Omlet</h5>
              
            </div>
          </div>
          <div onClick="location.href='Dosa.html'" class="carousel-item">
            <img src="Dosa.JPG" class="d-block w-100" alt="Pastry">
            <div class="carousel-caption d-none d-md-block">
              <h5>Dosa</h5>
    ...
    <div class="item1" onClick="location.href='Cereals.html'"></div>
    <div class="item2" onClick="location.href='LemonRice.html'"></div>
</body>
