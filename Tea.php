...
<body>
  ...
  <div class="idli">
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Tea</h5><br>
        <h5 style="margin-top:-55px;margin-left:345px;background:transparent;">15/-</h5><br>
        ...
        <h5 style="margin-top:-30px;margin-left:300px;background:transparent;">20/-</h5><br>
