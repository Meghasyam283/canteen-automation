...
$FoodName='Roasted Biryani';
$FoodCode='ROASTBIRYANI';
$Price='150';
$Quantity='1';
...
<body>
  ...
  <div class="idli">
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Roasted Biryani</h5><br>
        <h5 style="margin-top:-55px;margin-left:345px;background:transparent;">145/-</h5><br>
        ...
        <h5 style="margin-top:-30px;margin-left:300px;background:transparent;">150/-</h5><br>
        <form method="POST" action="Roasted_Pay.php">
