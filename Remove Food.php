       ...
       <li><a href="View Feedback.php">View Feedback</a></li>
        <li><a href="#">Report</a>
         ...
         <div class="container1"></div>
           <form method="POST" action="Remove Food.php">
              <b style="font-size:25px; ">Food name:</b><input type="text" name="name" required><br><br>
              <b style="font-size:25px; ">Food-item no:</b><input type="text" name="id"  required style="font-size:15px;"><br><br>

              <b style="font-size:25px; ">Category:</b><select  name="category"required><option name="category">BreakFast</option>
