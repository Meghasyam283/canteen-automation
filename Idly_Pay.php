...
<body>
  ...
  <div class="idli">
    ...
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Idli</h5><br>
        <h5 style="margin-top:-55px;margin-left:300px;background:transparent;">20/-</h5><br><br>
        <!-- <h5 style="margin-left:35px;background:transparent;">No of pieces: 5</h5> -->
        <h5 style="margin-top:-25px;margin-left:30px;background:transparent;">Quantity:</h5><span>
        ...
        <h5 style="margin-top:-30px;margin-left:300px;background:transparent;">25/-</h5><br>
        <form method="POST" action="Idly_Pay.php">
