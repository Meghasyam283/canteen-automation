...
<body>
  ...
  <div class="idli">
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Tandoori Chicken</h5><br>
        <h5 style="margin-top:-55px;margin-left:345px;background:transparent;">200/-</h5><br>
        ...
        <h5 style="margin-top:-30px;margin-left:300px;background:transparent;">205/-</h5><br>
        <form method="POST" action="Tandoori_Pay.php">
          <input type="submit"  style=" height:35px; width:130px;border-radius:7px;background: rgb(106,230,94);
          background: radial-gradient(circle, rgba(106,230,94,1) 0%, rgba(162,212,134,1) 100%);font-size:16px;margin-left:120px;" name="Tandoori_Pay" value="Confirm Order">
        </form>
    </div>
  </div>
</body>
