...
<body>
  ...
  <div class="idli">
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Bread Omlet</h5><br>
        <h5 style="margin-top:-55px;margin-left:300px;background:transparent;">50/-</h5><br>
        ...
        <form method="POST" action="Bread_Pay.php">
          <input type="submit"  style=" height:35px; width:130px;border-radius:7px;background: rgb(106,230,94);
          background: radial-gradient(circle, rgba(106,230,94,1) 0%, rgba(162,212,134,1) 100%);font-size:16px;margin-left:120px;" name="Bread" value="Confirm Order">
        </form>
    </div>
  </div>
</body>
