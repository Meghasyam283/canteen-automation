...
<body>
  ...
  <div class="idli">
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Milk Shake</h5><br>
        <h5 style="margin-top:-55px;margin-left:345px;background:transparent;">30/-</h5><br>
        <!-- <h5 style="margin-left:35px;background:transparent;">No of pieces: 3</h5> -->
        ...
        <h5 style="margin-top:-30px;margin-left:300px;background:transparent;">0/-</h5>
        <div style="margin-left:5px;height:0.5px;width:385px;border:1px solid black"class="div1"></div><br>
        <h5 style="margin-left:35px;background:transparent;">Total Bill:  </h5>
        <h5 style="margin-top:-30px;margin-left:300px;background:transparent;">30/-</h5><br>
        <form method="POST" action="Milk_Pay.php">
          <input type="submit"  style=" height:35px; width:130px;border-radius:7px;background: rgb(106,230,94);
          background: radial-gradient(circle, rgba(106,230,94,1) 0%, rgba(162,212,134,1) 100%);font-size:16px;margin-left:120px;" name="Milk_Pay" value="Confirm Order">
        </form>
    </div>
  </div>
</body>
