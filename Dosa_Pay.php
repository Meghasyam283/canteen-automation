...
<body>
  ...
  <div class="idli">
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Dosa</h5><br>
        <h5 style="margin-top:-55px;margin-left:300px;background:transparent;">20/-</h5><br>
        ...
        <form method="POST" action="Dosa_Pay.php">
