...
session_start();
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            die("Sorry we failed to connect: ". mysqli_connect_error());
                ...
                $sql = "INSERT INTO `combo` (`combo_id`, `comboname`, `category`,`Quantity`,`Amount`,`date`)
                ...
                if($result){
                  ...
                  <strong style="position:absolute;text-align:center;top:150px;font-size:25px;left:500px;">Success! Combo has been added successfully!</strong>
                  <button type="button"style="position:absolute;top:155px;left:990px;color:white;background-color:red;font-size:15px;border:2px solid red;" class="close" data-dismiss="alert" aria-label="Close" onclick="fun()">
       ...
       <li class="nav"><a href="View Feedback.php">View Feedback</a></li>
        <li class="nav"><a href="#">Report</a>
         ...
         <div class="container1"></div>
           <form method="POST" action="Add combo.php">
              <b style="font-size:20px;">Combo-id:</b><input type="text"  name="id" required style="margin-left:13px;"><br><br>
              <b style="font-size:20px;">Combo Name:</b><input type="text" name="name" required><br><br>
              <b style="font-size:20px;">Category:</b><select name="category" required><option name="category">BreakFast</option>
                ...
                <option name="category">Beverages</option></select><br><br>
                ...
                <button type="submit" Style="height:40px;width:80px; border:2px solid chartreuse; border-radius:30px;background-color:chartreuse; font-size:20px;">Submit</button>
                </form>
                <script>
