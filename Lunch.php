...
<div class="Slide">
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div onClick="location.href='Veg.html'" class="carousel-item active">
            <img src="Naan.jpg" class="d-block w-100" alt="Idli">
            <div class="carousel-caption d-none d-md-block">
              <h5 >Veg</h5>
              
            </div>
          </div>
          <div  onClick="location.href='Non-Veg.html'" class="carousel-item">
            <img src="Sambar.jpg" class="d-block w-100" alt="Chicken">
            <div class="carousel-caption d-none d-md-block">
              <h5>Non-Veg</h5>
              
            </div>
          </div>
          <div onClick="location.href='Special.html'" class="carousel-item">
            <img src="momos.JPG" class="d-block w-100" alt="Pastry">
            <div class="carousel-caption d-none d-md-block">
              <h5 >Special</h5>
    ...
    <div class="item1" onClick="location.href='Ricemeal.html'"></div>
    <div class="item2" onClick="location.href='Roasted_Biryani.html'"></div>
</body>
