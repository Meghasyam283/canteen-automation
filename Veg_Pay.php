...
<body>
  ...
  <div class="idli">
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Veg Meal</h5><br>
        <h5 style="margin-top:-55px;margin-left:300px;background:transparent;">85/-</h5><br>
        ...
        <h5 style="margin-top:-30px;margin-left:300px;background:transparent;">90/-</h5><br>
        <form method="POST" action="Veg_Pay.php">
