...
<body>
  ...
  <div class="idli">
    <div class="Bill">
        ...
        <h5 style="margin-left:35px;background:transparent;">Items Ordered: Chocolate Cake</h5><br>
        <h5 style="margin-top:-55px;margin-left:345px;background:transparent;">245/-</h5><br>
        ...
        <h5 style="margin-top:-30px;margin-left:300px;background:transparent;">250/-</h5><br>
        <form method="POST" action="Cake_Pay.php">
