...
<body>
    <div class="container">
       ...
       <li><a href="view Feedback.php">View Feedback</a></li>
        <li><a href="#">Report</a>
         ...
         <div class="container1"></div>
           <form method="POST" action="Sales per item.php">
              <b style="position:absolute;font-size:25px;left:250px;top:-300px;">Food Name:</b><input type="text" name="name" required style="left:-150px; position:relative;top:-300px;">
              <b style="font-size:25px;position:absolute;font-size:25px;left:570px;top:-300px;">From Date:</b><input type="date" name="d1" required placeholder="HH:MM:SS" style="position:absolute;top:-300px;margin-left:5px;">
              <b style="font-size:25px;position:relative;left:160px;top:-300px;">To date:</b><input type="date" name="d2" required  placeholder="HH:MM:SS"style="font-size:15px;left:150px;position:relative;top:-300px;"><br><br>
      <button type="submit" Style=" position:relative;height:40px;width:200px;top:-300px; border:2px solid black; border-radius:30px;background-color:chartreuse; font-size:20px;">Search per item</button>
     </form>
        <br>
        <?php
        session_start();
     ...
     {
        $d1=$_POST["d1"];$d2=$_POST["d2"];$food=$_POST["name"];
         if(empty($_POST["d1"]))
         {
            $valid=FALSE;
         }
      ...
      die("Sorry we failed to connect: ". mysqli_connect_error());
          ...
          $sql = "SELECT * FROM `foodorder` WHERE foodname='$food' AND Date BETWEEN '$d1' AND '$d2'";
...
if($count==0)
{
    echo "<div class='count'>Sorry!No sales of $food found from $d1 to $d2 !</div>";
}
else{
